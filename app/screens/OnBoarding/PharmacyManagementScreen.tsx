...
export default function PharmacyManagementScreen() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      {/* Progress Stepper */}
      <ProgressStepper totalSteps={4} currentStep={3} />

      {/* Onboarding Component */}
      <View style={styles.onboardingContainer}>
        <OnboardingComponent
          title="Pharmacy Management"
          description="Easily manage orders and maintain an organized, top-notch service for customers."
          imageSource={require('../../../assets/images/onboarding/pic3.png')} // Replace with your actual image path
        />
      </View>
      ...
      <View style={styles.buttonContainer}>
        <CustomButton
          title="Continue"
          onPress={() => router.push('/screens/OnBoarding/GetStartedScreen')}
        />
      </View>
    </View>
  );
